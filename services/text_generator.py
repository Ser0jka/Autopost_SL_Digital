...
Сохраняй разметку и placeholders строго по пользовательскому заданию. СТРОГО укладывайся в 950 символов, мы делаем caption для tg message, ЭТО ОЧЕНЬ ВАЖНО"""
